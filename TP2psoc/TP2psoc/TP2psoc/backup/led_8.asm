...
export _LED_8_Switch
export  LED_8_Switch

export _LED_8_Invert
export  LED_8_Invert

export _LED_8_GetState
export  LED_8_GetState
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_8_Start(void)
;  FUNCTION NAME: LED_8_Stop(void)
;
;  FUNCTION NAME: LED_8_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(1)                                            ; Active High Digit Drive
   or   [Port_0_Data_SHADE],LED_8_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_0_Data_SHADE],~LED_8_PinMask
ENDIF
   jmp  .Switch_LED
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_8_Invert(void)
;
;  DESCRIPTION:
;     Invert state of LED                               
;
...
_LED_8_Invert:
 LED_8_Invert:
   ...
   xor  [Port_0_Data_SHADE],LED_8_PinMask
   mov  A,[Port_0_Data_SHADE]
   mov  reg[LED_8_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_8_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,LED_8_PinMask               ; Mask off the trash
