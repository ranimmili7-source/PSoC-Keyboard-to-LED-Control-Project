...
export LoadConfig_tp2psoc
export _LoadConfig_tp2psoc
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_tp2psoc
	lcall	LoadConfigTBL_tp2psoc_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration tp2psoc
;
;    Load configuration registers for tp2psoc.
...
_LoadConfig_tp2psoc:
 LoadConfig_tp2psoc:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_tp2psoc_Bank0
    mov     X, <LoadConfigTBL_tp2psoc_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_tp2psoc_Bank1
    mov     X, <LoadConfigTBL_tp2psoc_Bank1
