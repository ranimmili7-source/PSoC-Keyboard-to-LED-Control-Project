...
export _LED_7_Switch
export  LED_7_Switch

export _LED_7_Invert
export  LED_7_Invert

export _LED_7_GetState
export  LED_7_GetState
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_7_Start(void)
;  FUNCTION NAME: LED_7_Stop(void)
;
;  FUNCTION NAME: LED_7_Switch(void)
;
;  DESCRIPTION: ( Switch )
;     Turn LED on or off     
;
...
IF(1)                                            ; Active High Digit Drive
   or   [Port_0_Data_SHADE],LED_7_PinMask
ELSE                                             ; Active Low Digit Drive
   and  [Port_0_Data_SHADE],~LED_7_PinMask
ENDIF
   jmp  .Switch_LED
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_7_Invert(void)
;
;  DESCRIPTION:
;     Invert state of LED                               
;
...
_LED_7_Invert:
 LED_7_Invert:
   ...
   xor  [Port_0_Data_SHADE],LED_7_PinMask
   mov  A,[Port_0_Data_SHADE]
   mov  reg[LED_7_PortDR],A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: LED_7_GetState(void)
;
;  DESCRIPTION:
;     Get state of LED
;
...
ENDIF
   and   A,LED_7_PinMask               ; Mask off the trash
