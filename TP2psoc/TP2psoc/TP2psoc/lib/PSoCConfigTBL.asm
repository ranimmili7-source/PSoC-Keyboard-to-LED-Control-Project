...
export LoadConfigTBL_tp2psoc_Bank1
export LoadConfigTBL_tp2psoc_Bank0
export LoadConfigTBL_tp2psoc_Ordered
AREA lit(rom, rel)
LoadConfigTBL_tp2psoc_Bank0:
;  Instance name LED_1, User Module LED
;  Instance name LED_2, User Module LED
;  Instance name LED_3, User Module LED
;  Instance name LED_4, User Module LED
;  Instance name LED_5, User Module LED
;  Instance name LED_6, User Module LED
;  Instance name LED_7, User Module LED
;  Instance name LED_8, User Module LED
